...
private: System::Windows::Forms::Button^ ButtonValAchatAccueil;
private: System::Windows::Forms::Button^ ButtonValComAccueil;
...
private: System::Windows::Forms::Button^ ButtonSimulTVAAccueil;

private: System::Windows::Forms::Button^ ButtonSimulComAccueil;

private: System::Windows::Forms::TextBox^ TextBoxMargeAccueil;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->EcranPasserCommande->Controls->Add(this->button3);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(352, 465);
			...
			this->labelMoyenDePaiementPasserCommande->Location = System::Drawing::Point(16, 324);
			this->labelMoyenDePaiementPasserCommande->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->labelMoyenDePaiementPasserCommande->Name = L"labelMoyenDePaiementPasserCommande";
			this->labelMoyenDePaiementPasserCommande->Size = System::Drawing::Size(100, 13);
			...
			this->textBoxMoyenDePaiementPasserCommande->Location = System::Drawing::Point(126, 322);
			this->textBoxMoyenDePaiementPasserCommande->Margin = System::Windows::Forms::Padding(2);
			this->textBoxMoyenDePaiementPasserCommande->Name = L"textBoxMoyenDePaiementPasserCommande";
			this->textBoxMoyenDePaiementPasserCommande->Size = System::Drawing::Size(76, 20);
			...
			this->labelDesignationPasserCommande->Location = System::Drawing::Point(51, 138);
...
#pragma endregion
	...
	private: System::Void buttonValiderPasserCommande_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		textBoxDesignationPasserCommande->Text = "";
		textBoxAnneDateEmissionPasserCommande->Text = "";
		textBoxMoisDateEmissionPasserCommande->Text = "";
		textBoxJourDateEmissionPasserCommande->Text = "";
		textBoxAnneeDatePaiementPasserCommande->Text = "";
		textBoxMoisDatePaiementPasserCommande->Text = "";
		textBoxJourDatePaiementPasserCommande->Text = "";
		textBoxAnneeDateSoldePasserCommande->Text = "";
		textBoxMoisDateSoldePasserCommande->Text = "";
		textBoxJourDateSoldePasserCommande->Text = "";
		textBoxMoyenDePaiementPasserCommande->Text = "";
		textBoxQtePasserCommande->Text = "";
		textBoxAnneLivraisonPasserCommande->Text = "";
		textBoxMoisLivraisonPasserCommande->Text = "";
		textBoxJourLivraisonPasserCommande->Text = "";
	...
	private: System::Void ClickValComAccueil(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("La valeur commerciale de l'intégralité du stock est : " + stat1.sommeStockCommercial(textBox1->Text, textBox2->Text, textBox3->Text) + "€");
	}

	private: System::Void ClickValAchatAccueil(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("La valeur commerciale de l'intégralité du stock est : " + Convert::ToSingle(stat1.sommeStockAchat(textBox1->Text, textBox2->Text, textBox3->Text)) + "€");
	}
	private: System::Void ClickSimulMargeAccueil(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("La valeur commerciale du stock serait de : " + stat1.simulCom(TextBoxMargeAccueil->Text, textBox1->Text, textBox2->Text, textBox3->Text) + " €");
		TextBoxMargeAccueil->Text = "";
		TextBoxTVAAccueil->Text = "";
	}
	private: System::Void ClickSimulTVAAccueil(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("La valeur d'achat du stock serait de : " + stat1.simulAchat(TextBoxMargeAccueil->Text,TextBoxTVAAccueil->Text, textBox1->Text, textBox2->Text, textBox3->Text) + " €");
		TextBoxMargeAccueil->Text = "";
		TextBoxTVAAccueil->Text = "";
	}
    ...
    private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		dataGridView1->DataSource = commande1.afficherCommande(textBoxIDCommandePasserCommande->Text, textBox1->Text, textBox2->Text, textBox3->Text);
    }
};
}
